...
const FONTFACE = {
  version: (([major, minor]) => ({ major, minor }))(pkg.version.split('.')),
  name: 'Wavefont',
  min: 0,
  max: 100,
  // caret span -30..130 covers max ink (value 127 = 1270upm, top-align dip = -215upm): line-height 1.6 is overlap-free
  ascender: 130,
  descender: 30,
  alias: {
    0: BLANK,
    ...
    // 0x180 = max: clamp guard for value-128 off-by-one encoders (was blank)
    100: [...MAX_CHAR, BAR_CHAR[7], 0x180]
  },
